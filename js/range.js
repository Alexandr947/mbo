...
startPriceMin = 0;
startPriceMax = 1000;
elPriceMin.innerHTML = startPriceMin;
elPriceMax.innerHTML = startPriceMax;
...
window.onmousemove = function(event){
    ...
    if (mouse_down_l){
      ...
      elPriceMin.innerHTML = Math.round(rplPrice);
    ...
    if (mouse_down_r){
      ...
      elPriceMax.innerHTML = Math.round(rprPrice);
...
function onThumbMoveLeft(event) {
  ...
  rpl.style.left = rpl_position + "px"; 
  rplPrice = Math.round(startPriceMin*1 + (rpl_position )/(rprXstart - rplXstart-24)*(startPriceMax - startPriceMin)); 
  elPriceMin.innerHTML = rplPrice;
...
function onThumbMoveright(event) {
    ...
    rpr.style.left = rpr_position + "px";
    rprPrice = Math.round(startPriceMin*1 + (rpr_position - 24 )/(rprXstart - rplXstart-24)*(startPriceMax - startPriceMin)); 
    elPriceMax.innerHTML = rprPrice  
};
